...
namespace University.Web.Controllers
{
    public class OfficeAssignmentController : ApiController
    {
        ...
        [HttpPut]
        public async Task<IHttpActionResult> Put(OfficeAssignmentDTO officeAssignmentDTO, int id) // object - cuerpo pero si es prmitivo por la url 
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState); // status code 400
            ...
            try
            {
                ...
                return Ok(officeAssignment); //Sastus code 200
